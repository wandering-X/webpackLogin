...
}).controller("homeCtrl", ["$scope", "$state", "constant", "$http", ($scope, $state, constant, $http) => {
    $(document).scrollTop('0');
    //轮播图
